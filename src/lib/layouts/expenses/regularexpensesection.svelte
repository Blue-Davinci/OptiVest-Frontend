<script>
	...
	import CreateExepense from './createexepense.svelte';
	let { 
		data,
		defaultCurrency,
		budgetIDNames,
	...
	>
		<div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
			<div>
				...
				<p class="text-gray-600 dark:text-gray-300">View and manage all your recorded expenses</p>
			</div>
			<div class="flex flex-col gap-3 sm:flex-row sm:items-center">
				<div class="relative">
					<input
						...
						class="w-full rounded-lg border border-gray-200 bg-white py-2.5 pl-10 pr-4
                           text-gray-900 placeholder-gray-400 outline-none focus:border-transparent
                           focus:ring-2 focus:ring-purple-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100
                           dark:placeholder-gray-500 sm:w-72"
					/>
					<Search class="absolute left-3 top-3 h-5 w-5 text-gray-400 dark:text-gray-500" />
				</div>
				<CreateExepense {data} {budgetIDNames} {defaultCurrency} />
			</div>
		</div>
