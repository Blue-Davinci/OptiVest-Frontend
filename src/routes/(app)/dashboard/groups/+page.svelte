	...
	<div class="space-y-4 rounded-xl bg-gray-50 p-6 dark:bg-gray-800/50">
		<div class="flex flex-col space-y-4">
			<div class="flex items-center space-x-3">
				...
				<h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Groups You Created</h2>
			</div>
	...
	<div class="space-y-4 rounded-xl bg-gray-50 p-6 dark:bg-gray-800/50">
		<div class="flex flex-col space-y-4">
			<div class="flex items-center space-x-3">
				...
				<h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Groups You're In</h2>
			</div>
			<p class="text-sm text-gray-600 dark:text-gray-400">Groups where you're a member</p>
