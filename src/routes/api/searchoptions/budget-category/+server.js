import {VITE_API_BASE_SEARCH_OPTIONS_BUDGET_CATEGORIES} from '$env/static/private';
...
export const GET = async({ cookies }) => {
    ...
    try{
        const response = await fetch(VITE_API_BASE_SEARCH_OPTIONS_BUDGET_CATEGORIES, {
            method: 'GET',
            headers: {
