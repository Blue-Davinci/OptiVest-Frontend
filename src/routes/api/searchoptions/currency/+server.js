import {VITE_API_BASE_SEARCH_OPTIONS_CURRENCIES} from '$env/static/private';
...
export const GET = async({ cookies }) => {
    ...
    try{
        const response = await fetch(VITE_API_BASE_SEARCH_OPTIONS_CURRENCIES, {
            method: 'GET',
            headers: {
        ...
        console.log("SOC-IEP-SE error: ", err);
