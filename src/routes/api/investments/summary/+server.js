// VITE_API_BASE_INVESTMENTS_ANALYSIS_SUMMARY
import {VITE_API_BASE_INVESTMENTS_ANALYSIS_SUMMARY} from '$env/static/private';
...
export const GET = async({ cookies }) => {
    ...
    try{
        const response = await fetch(VITE_API_BASE_INVESTMENTS_ANALYSIS_SUMMARY, {
            method: 'GET',
            headers: {
        ...
        console.log("GPFSIEP-SE error: ", err);
