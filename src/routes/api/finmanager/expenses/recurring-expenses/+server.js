...
export const GET = async({ cookies, url }) => {
    ...
    let finalEndpoint = buildFeedFollowUrl(VITE_API_BASE_EXPENSES_RECURRING, params);
    console.log('GREEP Server: User is authenticated, token: ', auth);
    try{
        ...
        console.log('GREEP Server: API Response:', responseData);
        return json(responseData);
    }catch(err){
        console.log("GREEP-SE error: ", err);
